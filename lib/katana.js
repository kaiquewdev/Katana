			...
			App.series('request', function(error, results) {
				if (Request.module) {
				    ...
				    if (typeof(Controller[Request.action]) == 'function') {
					    ...
					    } else if (App.controllers[Config.controller_404] && typeof(App.controllers[Config.controller_404][Config.action_404]) == 'function') {
...
module.exports = global.App = new Katana;
